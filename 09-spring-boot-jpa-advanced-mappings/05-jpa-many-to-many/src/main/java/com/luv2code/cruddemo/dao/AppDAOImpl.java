...
public class AppDAOImpl implements AppDAO{
    ...
    public Course findCourseAndStudentsByCourseId(int id) {
        TypedQuery<Course> query=theEntityManager.createQuery("select c from Course c JOIN FETCH c.students where c.id=:data",Course.class);
        query.setParameter("data",id);
        Course c=query.getSingleResult();
        return c;
    }
    ...
    public Student findStudentAndCoursesByStudentId(int id) {
        TypedQuery<Student> query=theEntityManager.createQuery("select s from Student s JOIN FETCH s.courses where s.id=:data", Student.class);
        query.setParameter("data",id);
